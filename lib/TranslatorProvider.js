...
var TranslatorProvider = function (_React$Component) {
  _inherits(TranslatorProvider, _React$Component);

  function TranslatorProvider() {
    _classCallCheck(this, TranslatorProvider);

    return _possibleConstructorReturn(this, (TranslatorProvider.__proto__ || Object.getPrototypeOf(TranslatorProvider)).apply(this, arguments));
  }
...
exports.default = TranslatorProvider;